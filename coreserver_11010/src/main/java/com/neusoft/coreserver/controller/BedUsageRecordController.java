...
import com.neusoft.coreserver.entity.BedUsageRecord;
import com.neusoft.coreserver.entity.PageResponseBean;
import com.neusoft.coreserver.entity.ResponseBean;
import com.neusoft.coreserver.feignclient.ToolFeignClient;
import com.neusoft.coreserver.mapper.BedUsageRecordMapper;
import com.neusoft.coreserver.service.BedUsageRecordService;
...
public class BedUsageRecordController {
    ...
    public ResponseBean<String> delete(@RequestBody Map<String, Object> request) {
        ...
        map.put("message", "BedUsageRecord_UPDATE");
        toolFeignClient.sendAllMessage(map);
        return rb;
    }
